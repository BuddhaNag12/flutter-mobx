...
//
//     final pokeDesc = pokeDescFromJson(jsonString);

import 'dart:convert';

PokeDesc pokeDescFromJson(String str) => PokeDesc.fromJson(json.decode(str));

String pokeDescToJson(PokeDesc data) => json.encode(data.toJson());
...
class PokeDesc {
    ...
    factory PokeDesc.fromJson(Map<String, dynamic> json) => PokeDesc(
